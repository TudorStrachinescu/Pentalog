...
CREATE TABLE `authentication` (
  ...
  `user_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `user_authentication_fk` (`user_id`)
...
INSERT INTO `authentication` VALUES (1,'2019-06-02T13:13:25.958383200_tudor',1);
...
CREATE TABLE `transaction` (
  ...
  PRIMARY KEY (`id`),
  KEY `account_transaction_fk` (`from_account`)
...
INSERT INTO `transaction` VALUES (1,'ro12abcd1234567890123456',200.00,NULL,'details1',0,1),(2,'ro56asdf0987654321234567',100.00,NULL,'details4',1,6),(3,'ro54wgsd1234567890123456',30.00,NULL,'ditailsdsad',1,4),(4,'ro45zzds1234567890123456',20.00,NULL,'some details',0,3),(5,'ro23wers1234567890123456',123.00,NULL,'nodetails',0,2);
...
-- Dump completed on 2019-06-02 17:46:03
